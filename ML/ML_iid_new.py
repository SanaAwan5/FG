    ...
    for i in range(iterations):
        ...
        if memory_size > 0:
            ...
            for k in range(len(list_of_models)):
                ...
                delta[k, :],_ = list_of_models[k].privateFun(weights, 
                    batch_size=batch_size, num_iterations=fed_avg_size)
        ...
        #this_delta = model_aggregator.foolsgold(delta, summed_deltas, sig_features_idx, i, weights, clip=0)
        
        # Krum
        this_delta = model_aggregator.krum(delta, clip=2)
